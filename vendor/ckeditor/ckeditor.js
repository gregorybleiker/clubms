            ...
            fire: function () {
                ...
                return function (m, j, i) {
                    ...
                    if (n) {
                        var o = n.listeners;
                        if (o.length)
                            for (var o = o.slice(0), u, f = 0; f < o.length; f++) {
                                if (n.errorProof) try {
                                    u = o[f].call(this,
                                        i, j, d, h)
                                } catch (s) {} else u = o[f].call(this, i, j, d, h);
    ...
    (function () {
        ...
        CKEDITOR.tools = {
            ...
            buildStyleHtml: function (b) {
                for (var b = [].concat(b), a, d = [], g = 0; g < b.length; g++)
                    if (a = b[g]) /@import|[{}]/.test(a) ? d.push("<style>" + a + "</style>") : d.push('<link type="text/css" rel=stylesheet href="' + a + '">');
                return d.join("")
            },
            ...
            normalizeCssText: function (a, c) {
                var d = [],
                    g, e = CKEDITOR.tools.parseCssText(a, true, c);
...
"header", "hgroup", "mark", "meter", "nav", "output", "progress", "section", "summary", "time", "video"], g = d.length, e; g--;) {
    ...
    CKEDITOR.dom.element.setMarker = function (a, e, b, c) {
        var d = e.getCustomData("list_marker_id") || e.setCustomData("list_marker_id", CKEDITOR.tools.getNextNumber()).getCustomData("list_marker_id"),
            g = e.getCustomData("list_marker_names") || e.setCustomData("list_marker_names", {}).getCustomData("list_marker_names");
        a[d] = e;
        g[b] = 1;
        ...
        CKEDITOR.tools.extend(CKEDITOR.dom.element.prototype, {
            ...
            removeStyle: function (a) {
                ...
                if (!b.removeProperty && (a == "border" || a == "margin" || a == "padding")) {
                    ...
                    for (var b = [], j = 0; j < c.length; j++)
                        if (e)
                            for (var i = 0; i < e.length; i++) b.push([a, c[j], e[i]].join("-"));
            ...
            getDocumentPosition: function (a) {
                var b = 0,
                    ...
                    e = this.getDocument(),
                    j = e.getBody(),
                    i = e.$.compatMode == "BackCompat";
                if (document.documentElement.getBoundingClientRect) {
                    var n = this.$.getBoundingClientRect(),
                        r = e.$.documentElement,
                        o = r.clientTop ||
                            j.$.clientTop || 0,
                        u = r.clientLeft || j.$.clientLeft || 0,
                        f = true;
                    if (CKEDITOR.env.ie) {
            ...
            copyAttributes: function (a,
                ...
                for (var c = this.$.attributes, b = b || {}, e = 0; e < c.length; e++) {
                    var j = c[e],
                        ...
                        n;
                    if (!(i in b))
                        if (i == "checked" && (n = this.getAttribute(i))) a.setAttribute(i, n);
                        else if (j.specified || CKEDITOR.env.ie && j.nodeValue && i == "value") {
...
"border-right-width", "padding-left", "padding-right"],
        ...
        function a(a, b) {
            ...
            if (!a && !this._.guardLTR) {
                var t = f.type == CKEDITOR.NODE_ELEMENT ? f : f.getParent(),
                    h = f.type == CKEDITOR.NODE_ELEMENT ? f.getChild(e) : f.getNext();
            ...
            if (a && !this._.guardRTL) {
                var i = d.type == CKEDITOR.NODE_ELEMENT ? d : d.getParent(),
                    w = d.type == CKEDITOR.NODE_ELEMENT ? n ? d.getChild(n - 1) : null : d.getPrevious();
            ...
            if (this.current) f = this.current[j](false, q, g);
            else {
                if (a) f.type ==
                    CKEDITOR.NODE_ELEMENT && (f = e > 0 ? f.getChild(e - 1) : g(f, true) === false ? null : f.getPreviousSourceNode(true, q, g));
                else {
                    f = d;
        ...
        var c = function (a) {
            a.collapsed = a.startContainer && a.endContainer && a.startContainer.equals(a.endContainer) && a.startOffset == a.endOffset
                ...
                for (c = q; c < l.length; c++) {
                    ...
                    if (!g[c] || i.$.parentNode != g[c].$.parentNode)
                        for (i = i.getPrevious(); i;) {
                            if (i.equals(g[c]) || i.equals(f)) break;
                            m = i.getPrevious();
                            if (b == 2) h.$.insertBefore(i.$.cloneNode(true), h.$.firstChild);
                            else {
                                i.remove();
        ...
        CKEDITOR.dom.range.prototype = {
            ...
            enlarge: function (a, b) {
                ...
                case CKEDITOR.ENLARGE_ELEMENT:
                                ...
                                if (q.type == CKEDITOR.NODE_TEXT) {
                                    ...
                                    if (t && CKEDITOR.dtd.$removeEmpty[q.getName()]) {
                                        ...
                                        if (d.test(h)) q = null;
                                            ...
                                            for (var m = q.$.getElementsByTagName("*"), K = 0, C; C = m[K++];)
                    ...
                    if (i.type == CKEDITOR.NODE_TEXT)
                        if (CKEDITOR.tools.trim(i.substring(m)).length) t = true;
                        else {
                            t = !i.getLength();
                            if (m == i.getLength()) {
                ...
                case CKEDITOR.ENLARGE_LIST_ITEM_CONTENTS:
                    ...
                    var I, v, x = CKEDITOR.dom.walker.blockBoundary(a == CKEDITOR.ENLARGE_LIST_ITEM_CONTENTS ? {
                            br: 1
                        } : null),
                        G = null,
                        B = function (a) {
            ...
            shrink: function (a, b, c) {
                if (!this.collapsed) {
                    ...
                    if (e && e.type == CKEDITOR.NODE_TEXT)
                        if (l)
                            if (l >= e.getLength()) d.setEndAfter(e);
                            else {
                                d.setEndAfter(e);
                                k = 0
        ...
        a.prototype = {
            getNextParagraph: function (a) {
                ...
                for (this._.nextNode = null; s;) {
                    var y = 0,
                        l = s.hasAscendant("pre"),
                        p = s.type != CKEDITOR.NODE_ELEMENT,
                        k = 0;
                    if (p) s.type == CKEDITOR.NODE_TEXT && d.test(s.getText()) && (p = 0);
                    else {
                        var q = s.getName();
                        if (CKEDITOR.dtd.$block[q] && s.getAttribute("contenteditable") == "false") {
                            ...
                            c(this, a, b);
                            break
                        } else if (s.isBlockBoundary(this.forceBrBreak && !l && {
                            br: 1
                        })) {
                            if (q == "br") p = 1;
                            else if (!h && !s.getChildCount() &&
                                q != "hr") {
                                b = s;
                                r = s.equals(f);
                                break
                    ...
                    if (h && !y)
                        for (; !s.getNext(m) && !r;) {
                            q = s.getParent();
                            if (q.isBlockBoundary(this.forceBrBreak && !l && {
                                br: 1
                            })) {
                                y = 1;
                                p = 0;
                ...
                if (!b) {
                    ...
                    b = b.block;
                    if (!b && s && !this.enforceRealBlocks && y[s.getName()] && h.checkStartOfBlock() && h.checkEndOfBlock() && !s.equals(h.root)) b = s;
                    ...
                    a: if (a.nothingRequired) f = true;
                        ...
                        if (l = a.requiredClasses) {
                            ...
                            for (f = 0; f < l.length; ++f)
                                if (CKEDITOR.tools.indexOf(k, l[f]) == -1) {
                                    f = false;
                                    break a
                                }
                        }
                        ...
                        for (var e = f.type == CKEDITOR.NODE_DOCUMENT_FRAGMENT || f.name == "body", g, l = d.length; l > 0;) {
                            ...
                            if (e && (k.type == CKEDITOR.NODE_TEXT || k.type == CKEDITOR.NODE_ELEMENT && q.$inline[k.name])) {
                                ...
                                f.type != CKEDITOR.NODE_DOCUMENT_FRAGMENT && (k.type ==
                                    CKEDITOR.NODE_ELEMENT && !q[f.name][k.name]) && c.push({
                                    check: "el-up",
                                    el: k
                                })
                            }
            ...
            for (e in d)
                if (e == "class") {
                    ...
                    for (k = a.classes.join("|"); g =
                        c.pop();)
                        if (k.indexOf(g) == -1) return false
                } else if (a.attributes[e] != d[e]) return false;
            for (l in f)
                if (a.styles[l] != f[l]) return false;
            return true
        }
                        ...
                        a: {
                            ...
                            if (s)
                                for (e = 0; e < s.length; ++e)
                                    if ((B = d.match(s[e])) && B[0].length == d.length) {
                                        c = true;
                                        break a
                                    }
        ...
        load: function (a, e, b) {
            ...
            CKEDITOR.scriptLoader.load(g, function (a, d) {
                ...
                for (var g = 0; g < a.length; g++)
                    for (var f = h[a[g]], s = 0; s < f.length; s++) {
                        var i = f[s];
                        m[i] = this.get(i);
                        c[i] = 1
                    }
            ...
            var g = {}, h = function (b) {
                    a.call(this, b, function (a) {
                        ...
                        for (m in a) {
                            ...
                            if (!e[m]) {
                                if (r.icons)
                                    for (var u = r.icons.split(","), f = u.length; f--;) CKEDITOR.skin.addIcon(u[f], r.path + "icons/" + (CKEDITOR.env.hidpi && r.hidpi ? "hidpi/" : "") + u[f] + ".png");
                                e[m] = 1
                            }
                            if (o) {
                                o.split && (o = o.split(","));
        ...
        function n(a) {
            ...
            CKEDITOR.plugins.load(c.split(","), function (c) {
                ...
                for (var l in c) {
                    ...
                    if (h && !a.lang[l]) {
                        h.split && (h = h.split(","));
                        if (CKEDITOR.tools.indexOf(h, a.langCode) >= 0) i = a.langCode;
                        else {
                            i = a.langCode.replace(/-.*/, "");
                            i = i != a.langCode && CKEDITOR.tools.indexOf(h, i) >= 0 ? i : CKEDITOR.tools.indexOf(h, "en") >= 0 ? "en" : h[0]
                        } if (!p.langEntries || !p.langEntries[i]) k.push(CKEDITOR.getUrl(p.path + "lang/" + i + ".js"));
                        else {
    ...
    (function () {
        ...
        CKEDITOR.htmlParser.fragment.fromHtml = function (d, g, h) {
            ...
            var u = new CKEDITOR.htmlParser,
                f = g instanceof CKEDITOR.htmlParser.element ? g : typeof g == "string" ? new CKEDITOR.htmlParser.element(g) : new CKEDITOR.htmlParser.fragment,
                s = [],
                y = [],
                l = f,
                p = f.name == "textarea",
                ...
                if (a(f)) s.push(f);
                    ...
                    if (d == "pre") k =
                        ...
                        for (;;) {
                            ...
                            if (!f.isUnknown && !l.isUnknown && !h[d])
                                if (l.isOptionalClose) u.onTagClose(g);
                                ...
                                "li" ? "ul" : "dl", {}, 0, 1);
                            else if (g in e && !o(d, g)) {
                                !f.returnPoint && (f.returnPoint = l);
                                l = l.parent
                            } else {
                                g in CKEDITOR.dtd.$inline && s.unshift(l);
                                if (l.parent) n(l, l.parent, 1);
                                else {
                                    f.isOrphan = 1;
                                    break
                                }
            ...
            u.onText = function (a) {
                ...
                var d = l.name,
                    f = d ? CKEDITOR.dtd[d] || (l._.isBlockLike ? CKEDITOR.dtd.div : CKEDITOR.dtd.span) : c;
                if (!p && !f["#"] && d in e) {
    ...
    (function () {
        ...
        CKEDITOR.htmlParser.filter = CKEDITOR.tools.createClass({
            ...
            proto: {
                ...
                onElement: function (a, c) {
                    for (var d = [this.elementsRules["^"], this.elementsRules[c.name], this.elementsRules.$], e, h = 0; h < 3; h++)
                        if (e = d[h]) {
                            e = e.exec(a, c, this);
        ...
        a.prototype = {
            ...
            addMany: function (a,
                c, d) {
                for (var e = [this.findIndex(c), 0], h = 0, m = a.length; h < m; h++) e.push({
                    value: a[h],
                    priority: c,
                    options: d
                });
    ...
    (function () {
        function a(a, e) {
                ...
                return function (e) {
                    if (e.type != CKEDITOR.NODE_DOCUMENT_FRAGMENT) {
                        var k = [],
                            ...
                            B, q;
                        if (p)
                            for (l(p, 1) && k.push(p); p;) {
                                if (g(p) && (B = c(p)) && l(B))
                                    if ((q = c(B)) && !g(q)) k.push(B);
                                    else {
                                        f(v).insertAfter(B);
                                        B.remove()
                                    }
            ...
            function l(a, b) {
                ...
                if (a.type == CKEDITOR.NODE_TEXT && (c = a.value.match(y))) {
                    ...
                    if (!v)
                        if ((c = a.previous) && c.name == "br" || !c || g(c)) return true
                }
                return false
            }
            var t = {
        ...
        var y = /(?:&nbsp;|\xa0)$/,
            l = "{cke_protected}",
            p = CKEDITOR.dtd,
            k = ["caption", "colgroup", "col", "thead", "tfoot",
"tbody"],
    ...
    (function () {
        ...
        CKEDITOR.inlineAll = function () {
            ...
            for (b in CKEDITOR.dtd.$editable)
                for (var c = CKEDITOR.document.getElementsByTag(b), d = 0, g = c.count(); d < g; d++) {
                    a = c.getItem(d);
                    if (a.getAttribute("contenteditable") == "true") {
                        e = {
                            element: a,
    ...
    (function () {
            ...
            proto: {
                ...
                insertElementIntoSelection: function (a) {
                    ...
                    if (this.insertElementIntoRange(a, d)) {
                        ...
                        if (g)
                            if ((g = a.getNext(function (a) {
                                return c(a) && !j(a)
                            })) && g.type == CKEDITOR.NODE_ELEMENT && g.is(CKEDITOR.dtd.$block)) g.getDtd()["#"] ? d.moveToElementEditStart(g) : d.moveToElementEditEnd(a);
                            else if (!g && e != CKEDITOR.ENTER_BR) {
                        ...
                        this.attachListener(a, "key", function (b) {
                            ...
                            if (c in p) {
                                ...
                                if (CKEDITOR.env.ie && CKEDITOR.env.version < 11 && (d = b.getSelectedElement()) || (d = g(b))) {
                                    ...
                                    if ((i = h.block) && (m = i[c ? "getPrevious" : "getNext"](n)) && m.type == CKEDITOR.NODE_ELEMENT && m.is("table") &&
        ...
        var j =
            ...
            r = CKEDITOR.dom.walker.bookmark(false, true);
                ...
                if (a && a.isInline()) {
                    ...
                    if (c = this.ui.space(this.elementMode == CKEDITOR.ELEMENT_MODE_INLINE ?
                        ...
                        var e = CKEDITOR.tools.getNextId(),
                            d = CKEDITOR.dom.element.createFromHtml('<span id="' + e + '" class="cke_voice_label">' + this.lang.common.editorHelp + "</span>");
                        c.append(d);
        ...
        var o = function () {
            ...
            function b(c, e) {
                ...
                for (var t =
                    ...
                    if (a(d)) {
                        l = d.getName();
                        if (o && l in CKEDITOR.dtd.$list) p = p.concat(b(d, e));
                        else {
                            g = !! t[l];
            ...
            return function (i, n, r) {
                var o = i.editor;
                i.getDocument();
                var z = o.getSelection().getRanges()[0],
                    u = false;
                ...
                if (!z.checkReadOnly()) {
                    var v = (new CKEDITOR.dom.elementPath(z.startContainer, z.root)).blockLimit || z.root,
                        n = {
                            type: n,
                            dontFilter: u,
                            editable: i,
                    ...
                    if (!o.collapsed) {
                        var v = B.block || B.blockLimit,
                            V = o.getCommonAncestor();
                        v && (!v.equals(V) && !v.contains(V) && o.checkEndOfBlock()) && n.zombies.push(v);
                        o.deleteContents()
                    }
                    for (;
                        (D = a(o.startContainer) &&
                    ...
                    if (x = r) {
                        ...
                        if (/^\s+|\s+$/.test(r) && "span" in CKEDITOR.dtd[D]) var P = '<span data-cke-marker="1">&nbsp;</span>',
                        r = P + r + P;
                        ...
                        for (k(G, E); x < G.length; x++) {
                            ...
                            if (A = B.isLineBreak) {
                                ...
                                if (B.hasBlockSibling) A = 1;
                                    ...
                                    if (!N || !N.is({
                                        ...
                                        W = N.getPosition(M);
                                        if (W == CKEDITOR.POSITION_IDENTICAL || W == CKEDITOR.POSITION_CONTAINS) A = 0;
                                        else {
                                            M = A.splitElement(N);
                                            A.moveToPosition(M,
                                                CKEDITOR.POSITION_AFTER_START);
                            ...
                            if (A) u = x > 0;
                                ...
                                if (T) {
                                    ...
                                    T = 0
                                } else E.insertNode(B.node); if (B.lastNotAllowed && x < G.length - 1) {
                    ...
                    for (T = L.createBookmark(); F = n.zombies.pop();)
                        if (F.getParent()) {
                            Q = L.clone();
                    ...
                    if (S)
                        for (; F = S.pop();) CKEDITOR.env.needsBrFiller ? F.appendBogus() :
                    ...
                    if (!n.dontMoveCaret) {
                        for (F = a(L.startContainer) && L.startContainer.getChild(L.startOffset - 1); F && a(F) && !F.is(h.$empty);) {
                            if (F.isBlockBoundary()) L.moveToPosition(F, CKEDITOR.POSITION_BEFORE_END);
                            else {
    ...
    (function () {
        ...
        function c(a) {
            ...
            var c = a.startContainer,
                e = a.getPreviousNode(o, null, c),
                d = a.getNextNode(o, null, c);
        ...
        var n, r, o = CKEDITOR.dom.walker.invisible(1),
            u = function () {
                function a(b) {
                    return function (a) {
        ...
        CKEDITOR.dom.selection = function (a) {
            ...
            if (CKEDITOR.env.webkit)(b.type == "None" && this.document.getActive().equals(a) || b.type == "Caret" && b.anchorNode.nodeType == CKEDITOR.NODE_DOCUMENT) && m(a, b);
            else if (CKEDITOR.env.gecko) b && (this.document.getActive().equals(a) && b.anchorNode && b.anchorNode.nodeType == CKEDITOR.NODE_DOCUMENT) && m(a, b, true);
            else if (CKEDITOR.env.ie) {
                var d;
                try {
                    d = this.document.getActive()
                } catch (e) {}
                if (f) b.type == "None" && (d && d.equals(this.document.getDocumentElement())) && m(a, null, true);
                else {
            ...
            getRanges: function () {
                var a = f ? function () {
                        ...
                        var b = function (b, c) {
                            ...
                            return {
                                container: n,
                                offset: j > 0 ? -k : n.nodeValue.length + k
                            }
                        };
                        return function () {
                        ...
                        if (i) this.fake(i);
                            ...
                            if (f) {
                                ...
                                if ((d = i.getEnclosedNode()) && d.type == CKEDITOR.NODE_ELEMENT && d.getName() in y && (!d.is("a") || !d.getText())) try {
                                    ...
                                    r.select();
                                    return
                                } catch (s) {}(i.startContainer.type == CKEDITOR.NODE_ELEMENT && i.startContainer.getName() in b || i.endContainer.type == CKEDITOR.NODE_ELEMENT && i.endContainer.getName() in b) && i.shrink(CKEDITOR.NODE_ELEMENT, true);
                                r = i.createBookmark();
                                b =
                                    r.startNode;
                                if (!a) h = r.endNode;
    ...
    CKEDITOR.editor.prototype.attachStyleStateChange = function (a, e) {
        ...
        if (!b) {
            ...
            this.on("selectionChange", function (a) {
                for (var d = 0; d < b.length; d++) {
                    var e = b[d],
                        h = e.style.checkActive(a.data.path) ? CKEDITOR.TRISTATE_ON : CKEDITOR.TRISTATE_OFF;
                    e.fn.call(this, h)
                }
            })
        }
    ...
    (function () {
        ...
        function e(b) {
            ...
            if (b.collapsed) {
                ...
                var f = this.element,
                    g = this._.definition,
                    i, h = g.ignoreReadonly,
                    j = h || g.includeReadonly;
                ...
                for (o.getPosition(m) == CKEDITOR.POSITION_FOLLOWING && (o = 0); o;) {
                    ...
                    if (o.equals(m)) {
                        ...
                        var q = o.type == CKEDITOR.NODE_ELEMENT ? o.getName() : null,
                            p = q && o.getAttribute("contentEditable") == "false",
                            s = q && o.getAttribute("data-nostyle");
                        if (q && o.data("cke-bookmark")) {
                            o =
                                o.getNextSourceNode(true);
                            continue
                        }
                        if (p && j && CKEDITOR.dtd.$block[q])
                            for (var t = o, w = c(t), z = void 0, C = w.length, H = 0, t = C && new CKEDITOR.dom.range(t.getDocument()); H < C; ++H) {
                                var z = w[H],
                        ...
                        if (w)
                            if ((w = o.getParent()) && ((w.getDtd() || CKEDITOR.dtd.span)[f] || i) && (!g.parentRule || g.parentRule(w))) {
                                ...
                                if (q == CKEDITOR.NODE_TEXT || p || q == CKEDITOR.NODE_ELEMENT && !o.getChildCount()) {
                                    for (var q = o, Y;
                                        (h = !q.getNext(K)) && (Y = q.getParent(), k[Y.getName()]) && (Y.getPosition(n) | I) == I && (!g.childRule || g.childRule(Y));) q = Y;
                                    r.setEndAfter(q)
                                }
                            } else h = true;
                            else h = true;
                        ...
                        for (var h = y(this, d), p = h.hasAttributes(), s = r.getCommonAncestor(), q = {}, w = {}, z = {}, C = {}, U, R, $; h && s;) {
                            if (s.getName() == f) {
                                for (U in g.attributes)
                                    if (!C[U] &&
                                        ($ = s.getAttribute(R))) h.getAttribute(U) == $ ? w[U] = 1 : C[U] = 1;
                                for (R in g.styles)
                                    if (!z[R] && ($ = s.getStyle(R))) h.getStyle(R) == $ ? q[R] = 1 : z[R] = 1
                            }
                            s = s.getParent()
                        }
        ...
        function o(a, b) {
            var c = this._.definition,
                ...
                h;
            for (h in d)
                if (!((h == "class" || this._.definition.fullMatch) && a.getAttribute(h) != q(h, d[h])) && !(b && h.slice(0, 5) == "data-")) {
                    g = a.hasAttribute(h);
                    a.removeAttribute(h)
                }
            for (var i in c)
                if (!(this._.definition.fullMatch && a.getStyle(i) != q(i, c[i], true))) {
                    g = g || !! a.getStyle(i);
                    a.removeStyle(i)
                }
            f(a, e, t[a.getName()]);
    ...
    CKEDITOR.tools.extend(CKEDITOR.dom.text.prototype, {
        ...
        split: function (a) {
            var e = this.$.parentNode,
                ...
                c = this.getLength(),
                d = this.getDocument(),
                g = new CKEDITOR.dom.text(this.$.splitText(a), d);
    ...
    (function () {
        function a(a, c, d) {
            var e = a.serializable,
                ...
                m = d ? "endOffset" : "startOffset",
                j = e ? c.document.getById(a.startNode) : a.startNode,
                ...
                var b = a.editor,
                    a = function (a) {
                        ...
                        if (!a.getById("cke_ui_color")) {
                            ...
                            m.push(a);
                            var e = b.getUiColor();
                            e && d([a], CKEDITOR.skin.chameleon(b, "panel"), [[j, e]])
                        }
                    };
                b.on("panelShow", a);
                b.on("menuShow", a);
